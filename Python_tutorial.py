...
# Author: Tori Jesser
#
# Purpose: Creating my first game demonstarting how to pass variables
...
def describe_game(name):
    ...
    """
    # meaning, if we do not alerady have this user's name,
...
def win(nice,mean,name):
    # Sunstitute the {} wildcards with our variable values
